...
public class NetworkRequestFactory {
    ...
    public void execute() throws IOException, InterruptedException {
        ...
        executorService.execute(new NetworkRequestExecutor(renderer, resourcesDirectory, routeAttributes, viewBytesMap, executorService, serverSocket, viewRenderers, persistenceConfig, securityAccessKlass, flashMessage, viewCache));
    }
